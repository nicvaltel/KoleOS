...
; qemu-virgil -drive format=raw,file=floppy.img

; dd if=/dev/zero of=floppy_disk.img bs=512 count=2880
; cat floppy.img | dd of=floppy_disk.img conv=notrunc
; qemu-virgil -drive format=raw,file=floppy_disk.img
         org 7C00h
